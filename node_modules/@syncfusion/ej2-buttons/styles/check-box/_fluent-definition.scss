...
$cbox-check-fontsize: 14px !default;
...
$cbox-hover-border-color: $primary-dark !default;
$cbox-hover-color: $icon-color !default;
...
//enddefault
// fluent theme
$cbox-check-content: '\e7b9' !default;
