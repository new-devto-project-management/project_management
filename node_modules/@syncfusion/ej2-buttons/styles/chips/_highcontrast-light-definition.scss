//General
$chip-bg-color: $bg-base-0 !default;
$chip-hover-bg-color: $hover-bg !default;
$chip-focus-bg-color: $bg-base-0 !default;
...
$chip-avatar-bg-color: lighten($border-fg, 12%) !default;
...
$chip-font-color: $content-font !default;
$chip-hover-font-color: $hover-font !default;
$chip-focus-font-color: $content-font !default;
$chip-active-font-color: $selection-font !default;
$chip-choice-active-font-color: $selection-font !default;
$chip-choice-focus-active-font-color: $chip-choice-active-font-color !default;
$chip-focus-active-font-color: $chip-active-font-color !default;
$chip-pressed-font-color: $selection-font !default;
$chip-disabled-font-color: $disable !default;
$chip-close-icon-font-color: rgba($chip-font-color, .8) !default;
$chip-close-icon-hover-font-color: $chip-hover-font-color !default;
$chip-close-icon-pressed-font-color: $chip-pressed-font-color !default;
$chip-icon-font-color: $content-font !default;
$chip-icon-hover-font-color: $hover-font !default;
$chip-icon-focus-font-color: $content-font !default;
$chip-icon-active-font-color: $selection-font !default;
$chip-icon-focus-active-font-color: $chip-active-font-color !default;
$chip-choice-icon-focus-active-font-color: $chip-choice-active-font-color !default;
$chip-icon-pressed-font-color: $selection-font !default;
$chip-avatar-font-color: $selection-font !default;
...
$chip-border-color: $border-fg !default;
...
$chip-outline-focus-bg-color: $bg-base-0 !default;
...
$chip-outline-focus-font-color: $content-font !default;
$chip-outline-active-font-color: $selection-font;
$chip-outline-choice-active-font-color: $chip-outline-active-font-color !default;
...
$chip-outline-pressed-font-color: $selection-font !default;
...
$chip-outline-icon-focus-font-color: $content-font !default;
$chip-outline-icon-active-font-color: $selection-font !default;
$chip-outline-icon-focus-active-font-color: $chip-outline-icon-active-font-color !default;
$chip-outline-choice-icon-focus-active-font-color: $chip-outline-choice-active-font-color !default;
$chip-outline-icon-pressed-font-color: $selection-font !default;
$chip-outline-avatar-font-color: $selection-font !default;
...
$chip-outline-hover-border-color: $hover-border !default;
...
$chip-primary-focus-border-color: darken($chip-primary-bg-color, 10%) !default;
...
$chip-success-hover-bg-color: $success-alt !default;
$chip-success-focus-bg-color: $success-alt !default;
...
$chip-success-font-color: $selection-font !default;
$chip-success-hover-font-color: $content-font !default;
$chip-success-focus-font-color: $content-font !default;
$chip-success-active-font-color: lighten($chip-success-bg-color, 20%) !default;
$chip-success-focus-active-font-color: $chip-success-active-font-color !default;
$chip-success-pressed-font-color: lighten($chip-success-bg-color, 20%) !default;
...
$chip-info-hover-bg-color: $info-alt !default;
$chip-info-focus-bg-color: $info-alt !default;
...
$chip-warning-hover-bg-color: $alert-alt !default;
$chip-warning-focus-bg-color: $alert-alt !default;
...
$chip-danger-hover-bg-color: $error-alt !default;
$chip-danger-focus-bg-color: $error-alt !default;
...
$chip-outline-success-hover-bg-color: $success-alt !default;
$chip-outline-success-focus-bg-color: $success-alt !default;
...
$chip-outline-success-avatar-hover-bg-color: lighten($chip-outline-success-hover-bg-color, 12%) !default;
...
$chip-outline-success-border-color: $success-bg !default;
...
$chip-outline-info-hover-bg-color: $info-alt !default;
$chip-outline-info-focus-bg-color: $info-alt !default;
...
$chip-outline-info-avatar-hover-bg-color: lighten($chip-outline-info-hover-bg-color, 12%) !default;
...
$chip-outline-info-border-color: $info-bg !default;
...
$chip-outline-warning-hover-bg-color: $alert-alt !default;
$chip-outline-warning-focus-bg-color: $alert-alt !default;
...
$chip-outline-warning-avatar-hover-bg-color: lighten($chip-outline-warning-hover-bg-color, 12%) !default;
...
$chip-outline-warning-border-color: $alert-bg !default;
...
$chip-outline-danger-hover-bg-color: $error-alt !default;
$chip-outline-danger-focus-bg-color: $error-alt !default;
...
$chip-outline-danger-avatar-hover-bg-color: lighten($chip-outline-danger-hover-bg-color, 12%) !default;
...
$chip-outline-danger-border-color: $error-bg !default;
