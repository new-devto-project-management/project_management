...
/**
 * E2E test helpers for Checkbox to easily interact and the test the component
 */
export declare class CheckBoxHelper extends TestHelper {
    id: string;
    wrapperFn: Function;
    /**
     * Initialize the Checkbox E2E helpers
     * @param id Element id of the Checkbox element
     * @param wrapperFn Pass the wrapper function
     * @return Checkbox any
     */
    constructor(id: string, wrapperFn: Function);
    /**
     * Used to get the root element of the Checkbox component.
     * @return Element
     */
    getElement(): any;
    /**
    ...
    /**
     * The invoke method is used to access the public methods available in Checkbox control.
     * @param fName - Specifies the method name of the Checkbox control.
