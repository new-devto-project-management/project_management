...
$dialog-content-padding: 24px !default;
$dialog-footer-content-padding: 0 24px 24px !default;
$dialog-footer-content-border-top: 0 solid $border-light !default;

$dialog-bigger-header-content-padding: 20px 28px 24px !default;
$dialog-bigger-content-padding: 28px !default;
$dialog-bigger-footer-content-padding: 0 28px 28px !default;
...
$dialog-bigger-close-button-left: 15px !default;
...
$dialog-bigger-header-btn-padding: 3px 8px !default;
