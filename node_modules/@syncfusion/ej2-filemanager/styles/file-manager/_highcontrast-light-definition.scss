...
$fm-skin-name: 'highcontrast-light' !default;
...
$fe-icon-color: #e0e0e0 !default;
$fe-label-color: #0275d8 !default;
$fe-text-color: #000 !default;
$fe-active-border-color: #e0e0e0 !default;
$fe-active-bg-color: #e0e0e0 !default;
$fe-active-font-color: #fff !default;
$fe-hover-border-color: #eee !default;
$fe-hover-bg-color: #eee !default;
$fe-ah-border-color: #eee !default;
$fe-ah-bg-color: #eee !default;
$fe-focus-border-color: #eee !default;
$fe-bc-color: $fe-text-color !default;
$fe-bc-link-color: $fe-label-color !default;
$fe-bc-hover-bg-color: #e0e0e0 !default;
$fe-bc-hover-font-color: #e0e0e0 !default;
$fe-grid-header-bg-color: #e0e0e0 !default;
$fe-grid-type-color: #0275d8 !default;
$fe-grid-text-color: #000 !default;
$fe-ddl-icon-color: #fff !default;
$fe-error-color: #f00 !default;
$fe-img-border-color: #fff !default;
$fe-search-bg-color: #e0e0e0 !default;
$fe-tb-hover-border-color: #fafafa !default;
$fe-tb-focus-border-color: #fafafa !default;
$fe-tb-focus-bg: #fafafa !default;
$fe-checkbox-color: #ffd939 !default;
$fe-checkbox-bg-color: #000 !default;
$fe-drop-border-color: #000 !default;
$fe-up-list-border-color: $border-default !default;
$fe-clone-bg-color: #e0e0e0 !default;
$fe-clone-border-color: #e0e0e0 !default ;
$fe-clone-count-border-color: #ffd939 !default;
$fe-clone-count-font-color: #ffd939 !default;
$fe-clone-count-bg-color:  #000 !default;
$fe-drop-folder-bg-color: #ffd939 !default;
...
$fe-bc-text-size: 28px !default;
$fe-bc-icon-margin: 0 4px !default;
$fe-bc-icon-padding: 5px !default;
$fe-bc-search-border-bottom: 0 !default;
