...
$listview-background: $default-bg-color !default;
...
$listview-header-text-color: $header-font-color !default;
$listview-header-text-padding: 16px !default;
$listview-header-text-disabled: $disable !default;
$listview-header-bg: $header-bg-color !default;
...
$listview-groupheader-bg: $header-bg-color !default;
