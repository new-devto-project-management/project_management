...
$listbox-item-padding: 12px 16px !default;
$listview-bigger-item-padding: 12px 16px !default;
...
$listview-touch-groupheader-line-height: 35px !default;
...
$listview-text-active-color: rgba($content-text-color, .87) !default;
...
$listview-header-border: rgba($black, .12) !default;
