...
$calendar-normal-month-view-line-height: 26px !default;
...
$calendar-bigger-month-view-line-height: 30px !default;
...
$calendar-small-month-view-line-height: 20px !default;
...
$calendar-active-bg-border-color: 1px solid $border !default;
...
$calendar-focused-today-border-style:  1px solid $border !default;
$calendar-focus-border-color: 1px solid $border !default;
...
$calendar-today-focus-color: $content-text-color !default;
//week header
...
$today-buuton-bg: $primary-bg-color !default;
$today-buuton-bg-border-color: $primary-border-color !default;
$today-buuton-text-color: $primary-text-color !default;
$today-buuton-hover-bg: $primary-bg-color-hover !default;
$today-buuton-bg-border-hover-color: $primary-border-color-hover !default;
$today-buuton-text-hover-color: $primary-text-hover !default;
$today-buuton-active-bg: $primary-bg-color-pressed !default;
$today-buuton-bg-border-active-color: $primary-border-color-pressed !default;
$today-buuton-text-active-color: $primary-text-pressed !default;
