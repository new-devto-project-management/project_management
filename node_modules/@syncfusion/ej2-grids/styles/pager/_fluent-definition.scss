...
$pager-tripledot-padding: 10px 11px 12px 11px !default;
$pager-numeric-icon-padding: 10px 11px 12px 11px !default;
$pager-pagecontainer-icon-padding: 12px 10px 13px 8px !default;
...
$pager-bigger-pagercontainer-icons-padding: 18.5px 10px 14px 10px !default;
...
$pager-dropdown-margin-top: -31px !default;
...
$pager-constant-margin: 0 0 9px 8px !default;
$pager-bigger-letter-spacing: 16.5px 10px 13px 10px !default;
