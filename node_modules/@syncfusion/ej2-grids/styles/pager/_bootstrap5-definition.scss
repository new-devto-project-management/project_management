...
$pager-rtl-navigation-icon-padding: 12.4px 9px 7.7px 2px !default;
$pager-rtl-numeric-margin: 0 !default;
$pager-item-hover-borders-width: 0 !default;
$pager-tripledot-font-size: 10px !default;
...
$pager-bigger-rtl-activeitem-padding: 17px 14px 13px 14px !default;
...
$pager-tripledot-padding: 12.5px 11px 8.5px 10px !default;
$pager-numeric-icon-padding: 8.5px 11px 8.5px 11px !default;
$pager-pagecontainer-icon-padding: 11px 10px 10px 8px !default;
...
$pager-bigger-pagercontainer-icons-padding: 18px 10px 14.5px 10px !default;
$pager-bigger-pagercontainer-icons-marign-right: 0 !default;
$pager-bigger-current-item-padding: 17.3px 14px 13px 14px !default;
...
$pager-bigger-dropdown-constant-margin: 9px !default;
$pager-bigger-dropdown-margin: -35px  10px 0 18px !default;
$pager-dropdown-height: 26px !default;
$pager-constant-margin: 0 0 3px 8px !default;
$pager-bigger-letter-spacing: 21.4px 10px 13px 10px !default;
$pager-tripledot-rtl-margin-top: 0 !default;
$pager-tripledot-rtl-padding: 13.7px 11px 6.4px 11px !default;
...
$pager-activeitem-padding: 10px 12px 6.4px 11px !default;
