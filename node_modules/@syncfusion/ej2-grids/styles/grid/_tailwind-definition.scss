...
$grid-columnchooser-toolbardiv-padding: 0 !default;
...
$grid-rtl-bigger-sortnumber-margin: 6px 0 0 33px !default;
...
$grid-bigger-rtl-group-headercell-margin: 16px 17px 0 0 !default;
$grid-bigger-rtl-group-headercell-padding: 4px 10px 4px 9px !default;
...
$grid-sortnumber-margin: 0 -8px 0 8px !default;
$grid-sortnumber-rightalign-margin: 0 8px 0 15px !default;
...
$grid-grouped-padding: 0 0 3.5px !default;
...
$grid-group-down-arrow-icon-font-size: 18px !default;
...
$grid-group-right-arrow-icon-font-size: 18px !default;
...
$grid-group-height: 38px !default;
$grid-ungroup-rtl-padding-top: 0 !default;
$grid-rtl-group-headercell-margin-right: 3.5px !default;
$grid-rtl-group-headercell-margin-left: 0 !default;
$grid-rtl-sortnumber-margin: 0 0 0 31px !default;
$grid-rtl-sortnumber-rightalign-margin: 0 0 0 31px !default;
...
$grid-rtl-headercelldiv-padding: 2px .4em 0 1.8em !default;
...
$group-sorticon-margin-top: -2.5px !default;
...
$grid-bigger-group-headercell-margin: 16.5px 0 0 10px !default;
...
$grid-bigger-icons-font-size: 22px !default;
...
$grid-bigger-ungroupbutton-icons-font-size: 22px !default;
$grid-bigger-groupcell-span-padding: 10px 10px 8px 12px !default;
...
$grid-bigger-header-icons-font-size: 12px !default;
...
$grid-rtl-headercelldiv-fltricon-margin: -1px -5px -5px -5px !default;
$grid-rtl-headercelldiv-rightalign-fltricon-margin: -1px -5px -5px -5px !default;
...
$grid-fltrdiv-margin: -17px -7px !default;
$grid-rtl-fltrdiv-margin: -17px 0 -20px -36px !default;
$grid-rtl-bigger-fltrdiv-margin: -20px 0 -18px -38px !default;
$grid-bigger-rtl-headercelldiv-fltricon-padding: -5px -10px -5px 0 !default;
$grid-bigger-fltrdiv-margin: -20px -6px !default;
$grid-icon-save: 'e964' !default;
$grid-sortdiv-filtericon-margin: -26px 20px -29px 0 !default;
$grid-sortdiv-filtericon-rightalign-margin: -26px -11px -5px -5px !default;
$grid-rtl-sortdiv-filtericon-rightalign-margin: -26px -4px 0 16px !default;
$grid-rtl-sortdiv-filtericon-margin: -26px -4px 0 16px !default;
...
$grid-rtl-bigger-fltricon-sortdiv-rightalign-margin: -26px 0 0 18px !default;
...
$grid-column-menu-margin: -19px -27px -5px -19px !default;
...
$grid-drag-font-size: 18px !default;
...
$grid-bigger-sortnumber-rightalign-margin: 3px 0 0 15px !default;
$grid-bigger-columnmenu-bottom: 13px !default;
$grid-bigger-sortnumber-margin: 3px 18px 0 2px !default;
$grid-rtl-searchclear: 0 !default;
$grid-column-chosser-searchdiv-top: -41px !default;
$grid-reorderarrow-font-size: 18px !default;
...
$grid-responsive-res-apply-btn-font-size: 18px !default;
$grid-responsive-res-apply-btn-margin-top: 0 !default;
$grid-responsive-sort-clear-btn-font-size: 18px !default;
...
$grid-responsive-header-padding-top: 7px !default;
...
$grid-rtl-sort-num-left-align-margin: 1px -2px 0 0 !default;
