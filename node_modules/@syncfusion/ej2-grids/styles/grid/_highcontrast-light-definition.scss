...
$grid-headercelldiv-right-align-padding: 0 !default;
$grid-headercelldiv-padding: 0 1px !default;
...
$grid-sortdiv-margin: -21px 11px !default;
...
$grid-sortnumber-margin: 9px 2px 0 2px !default;
$grid-sortnumber-rightalign-margin: 9px 0 0 15px !default;
...
$grid-rtl-sortnumber-margin: 8px 0 0 8px !default;
$grid-rtl-bigger-sortnumber-margin: 9px 0 0 3px !default;
$grid-rtl-sortnumber-rightalign-margin: 9px 0 0 30px !default;
...
$grid-rtl-sortcelldiv-right-align-margin: -22px 0 0 10px !default;
$grid-rtl-bigger-sortcelldiv-right-align-margin: -22px 0 0 22px !default;
...
$grid-bigger-sortdiv-margin: -23px 6px !default;
...
$grid-rtl-bigger-fltrdiv-margin: -26px -7px !default;
...
$grid-bigger-fltrdiv-margin: -23px -7px !default;
...
$grid-sortdiv-filtericon-margin: -22px 15px 0 0 !default;
$grid-rtl-sortdiv-filtericon-rightalign-margin: -22px 0 0 22px !default;
$grid-rtl-sortdiv-filtericon-margin: -16px 0 0 10px !default;
$grid-bigger-fltricon-sortdiv-rightalign-margin: -23px 11px 0 0 !default;
...
$grid-column-menu-margin: -24px !default;
$grid-textwrap-column-menu-margin: -20px -24px -24px -24px !default;
$grid-bigger-column-menu-margin: -8px -7px !default;
$grid-column-menu-top-touch: 31px !default;
$grid-column-menu-right-touch: 10px !default;
$grid-rtl-bigger-fltricon-sortdiv-margin: -23px 0 0 -7px !default;
$grid-rtl-bigger-fltricon-sortdiv-rightalign-margin: -23px 0 0 5px !default;
...
$grid-header-wrap-filtericon-sortfilter-div-margin: -16px 30px !default;
...
$grid-header-wrap-filtericon-rightalign-sortfilter-div-margin: -15px 8px !default;
...
// group animator
$grid-group-animator-bigger-cell-margin: 21px 0 20px 0 !default;
$grid-group-animator-bigger-drop-height: 72px;
$grid-animator-bigger-area-margin: 22px !default;
$grid-group-animator-drop-height: 58px;
...
$grid-animator-area-margin: 13px;
...
$grid-animator-margin-top-rtl: 20px !default;
...
$grid-responsive-search-padding-left: 28px !default;
...
$grid-responsive-res-apply-btn-margin-top: -3px !default;
...
$grid-responsive-filter-clear-margin: 2px !default;
...
$grid-rtl-sort-num-left-align-margin: 8px -2px 0 0 !default;
