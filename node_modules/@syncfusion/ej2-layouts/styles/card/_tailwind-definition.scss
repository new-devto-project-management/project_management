...
$card-header-nrml-padding: 18px !default;
...
$card-action-nrml-vertical-padding: 8px 18px !default;
...
$card-nrml-content-padding: 12px 18px !default;
...
$card-action-bigger-padding: 12px 24px !default;
$card-action-bigger-vertical-padding: 12px 24px 12px 24px !default;
...
$card-bigger-content-padding: 16px 24px !default;
...
$card-action-nrml-padding: 8px 18px !default;
