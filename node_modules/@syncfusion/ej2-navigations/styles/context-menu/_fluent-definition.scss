...
$cmenu-caret-blank-icon: $text-sm !default;
...
$cmenu-caret-color: $primary-outline !default;
...
$cmenu-icon-color: $primary-outline !default;
$cmenu-icon-disabled-color: $primary-outline !default;
...
$cmenu-caret-hover-color: $primary-outline !default;
$cmenu-hover-icon-color: $primary-outline !default;
