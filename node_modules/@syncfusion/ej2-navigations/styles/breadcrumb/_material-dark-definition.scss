...
$breadcrumb-popup-item-color: $grey-300 !default;
$breadcrumb-popup-border: none !default;
$breadcrumb-popup-bgcolor: $grey-800 !default;
$breadcrumb-popup-box-shadow: 0 8px 10px 0 rgba($grey-black, .24) !default;
$breadcrumb-popup-item-hover-bgcolor: rgba($grey-white, .1) !default;
$breadcrumb-popup-item-hover-color: $grey-dark-font !default;
$breadcrumb-popup-item-hover-outline: 0 solid $grey-700 !default;
