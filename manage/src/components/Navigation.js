       ...
       case 'files' : 
              ...
              <div className="modals-group">
                <ul className="list-group modals">
                          <Link to="/index1" className="list-group-item">
                            Open New Project
                          </Link>
              ...
              <div className="navigation frozen">
                ...
                <div className="nav">
                  ...
                  <div className="menu-icon" >
                    ...
                    <Link  onClick={()=>this.handleShow('files')} >
                    ...
                    <Link  onClick={()=>this.handleShow('tasks')}  >
                    ...
                    <Link onClick={()=>this.handleShow('Ressources')}>
                        <li className="nav-links nav-links-mobile">
                    ...
                    <Link onClick={()=>this.handleShow('tools')}>
                        <li className="nav-links nav-links-mobile">
                    ...
                    <Link  onClick={()=>this.handleShow('settings')}>
                        <li className="nav-links nav-links-mobile">
                            <span>           
